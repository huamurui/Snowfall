let doms = document.getElementsByClassName('test-dom')
let rects = []
for (let i = 0; i < doms.length; i++) {
  rects.push(doms[i].getBoundingClientRect())
};
...
(function (window) {
  ...
  Snowfall.prototype.drawSills = function () {
    for (let i = 2; i < this.sills.length; i++) {
  ...
  // i used to use this to create a new object, but it's not necessary
  // Sill = function (rect) {
  //   this.setRect(rect)
  // }
